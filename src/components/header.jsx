...
function Header() {
  return (
    <div className="h-[450px] lg:h-screen relative overflow-hidden " id="home">
      ...
      <div className="hidden lg:flex flex-col gap-5 rounded-lg shadow-xl absolute top-0 bottom-0 m-auto right-10 bg-white p-6 h-fit w-1/3 xl:right-20 2xl:w-1/5 2xl:right-[550px] xl:-top-20">
        <h1 className="text-4xl font-bold text-indigo-800">Hi I'm Alejandro</h1>
        <p className="text-gray-400">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque
          dignissimos, cum possimus placeat quo adipisci, impedit, nostrum
          quisquam quos libero in aliquam non error! Enim suscipit vero sunt
        </p>
        <a
          href="#contact"
